...
const Step5 = () => {
    ...
    return (
        <div className='flex lg:w-full lg:px-0 lg:h-full flex-col items-center justify-center text-center py-16 px-6'>
            ...
            <h2 className="text-blue-950 text-3xl my-4 font-bold">Thank you!</h2>
            <p className="text-gray-400 lg:w-[430px]">Thanks for confirming your subscription! We hope you have fun 
